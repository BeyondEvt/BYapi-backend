-- 创建库
create database if not exists BYapi;

-- 切换库
use BYapi;
# 1,,yxb1,,,admin,b0dd3697a192885d7c055db46155b26a,2023-09-18 21:25:03,2023-09-19 20:42:11,0
...
(
    ...
    userStatus   int          default 0                                  null comment '用户状态：0 - 正常 1 - 注销 2 - 封号',
...
-- 用户调用接口信息
create table if not exists BYapi.`user_interface_info`
(
