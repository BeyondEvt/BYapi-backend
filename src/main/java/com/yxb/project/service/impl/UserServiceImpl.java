...
import com.yxb.project.mapper.UserMapper;
...
import static com.yxb.project.constant.UserConstant.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    @Override
    public long userAdd(String userAccount, String userName) {
        ...
        synchronized (userAccount.intern()) {
            ...
            if (StringUtils.isBlank(userName)) userName = "用户" + System.currentTimeMillis() ;
